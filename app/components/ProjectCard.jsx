    ...
    <div>
      ...
      >
        {(!previewUrl || previewUrl.length === 0) && (
          <NotDeployedOverlay visible={showOverlay} />
        )}

        <div className="overlay rounded-t-lg items-center justify-center
          ...
          >
            <EyeIcon className="h-10 w-10 text-[#ADB7BE] absolute top-1/2 left-1/2
