...
const NotDeployedOverlay = ({ visible }) => (
  <div
    className={`absolute inset-0 flex items-center justify-center z-10
                 ...
                 ${visible ? "opacity-100 translate-x-0 pointer-events-auto" : "opacity-0 translate-x-full pointer-events-none"}`}
    style={{
      backdropFilter: "blur(2px)",
    }}
  >
    <span className="text-white text-lg md:text-lg font-medium px-6 py-3
